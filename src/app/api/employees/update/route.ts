...
const schema = z.object({
  ...
  contractTypeLabel: z.string().trim().max(80), employmentStatus: z.enum(["ACTIVE", "INACTIVE", "RESIGNED", "TERMINATED"]), monthlyDaysOff: z.coerce.number().int().min(0).max(31),
});
