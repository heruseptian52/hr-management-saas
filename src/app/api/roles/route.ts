...
const modules = ["company", "roles", "employees", "recruitment", "branches", "departments", "positions", "master_data", "shifts", "schedules", "attendance", "payroll", "kpi", "assets", "announcements", "audit"];
