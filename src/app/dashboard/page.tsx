...
export default async function Dashboard() {
  ...
  return <main className="dashboard-shell">
    <aside className="sidebar"><div className="sidebar-brand"><span><img src="https://panboycommunity.my.id/panboy-menu-logo.png" alt="Logo Panboy" /></span><strong>PANBOY HR</strong></div>
      <nav><a className="active" href="/dashboard">Ringkasan</a><a href="/self-service">Portal Saya</a>{hasPermission(membership.role.permissions, "employees", "view") && <><a href="/employees">Karyawan</a><a href="/contracts">Kontrak</a></>}{hasPermission(membership.role.permissions, "recruitment", "view") && <a href="/recruitment">Rekrutmen</a>}{hasPermission(membership.role.permissions, "training", "view") && <a href="/training">Pelatihan</a>}{hasPermission(membership.role.permissions, "discipline", "view") && <a href="/discipline">Pelanggaran & SP</a>}{hasPermission(membership.role.permissions, "branches", "view") && <a href="/organization">Organisasi</a>}{hasPermission(membership.role.permissions, "schedules", "view") && <a href="/schedules">Jadwal & Shift</a>}{hasPermission(membership.role.permissions, "attendance", "view") && <><a href="/attendance">Absensi</a><a href="/leave-requests">Cuti & Izin</a><a href="/leave-balances">Jatah Cuti</a><a href="/overtime">Lembur</a></>}{hasPermission(membership.role.permissions, "payroll", "view") && <a href="/payroll">Payroll</a>}{hasPermission(membership.role.permissions, "kpi", "view") && <a href="/kpi">KPI</a>}{hasPermission(membership.role.permissions, "assets", "view") && <a href="/assets">Aset</a>}{hasPermission(membership.role.permissions, "announcements", "view") && <a href="/announcements">Pengumuman</a>}<a href="/master-data">Master Data</a>{hasPermission(membership.role.permissions, "master_data", "view") && <a href="/holidays">Hari Libur</a>}{hasPermission(membership.role.permissions, "roles", "view") && <a href="/settings/roles">Role & Akses</a>}{hasPermission(membership.role.permissions, "company", "view") && <a href="/settings/company">Perusahaan</a>}</nav>
