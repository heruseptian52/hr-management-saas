...
const modules = [{ key: "company", name: "Perusahaan" }, { key: "roles", name: "Role & akses" }, { key: "employees", name: "Karyawan" }, { key: "branches", name: "Cabang" }, { key: "departments", name: "Departemen" }, { key: "positions", name: "Jabatan" }, { key: "shifts", name: "Shift" }, { key: "schedules", name: "Jadwal" }, { key: "attendance", name: "Absensi" }, { key: "audit", name: "Audit" }];
