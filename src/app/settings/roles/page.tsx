...
const modules = [{ key: "company", name: "Perusahaan" }, { key: "roles", name: "Role & akses" }, { key: "employees", name: "Karyawan" }, { key: "recruitment", name: "Rekrutmen & Onboarding" }, { key: "training", name: "Pelatihan & Pengembangan" }, { key: "discipline", name: "Pelanggaran & SP" }, { key: "branches", name: "Cabang" }, { key: "departments", name: "Departemen" }, { key: "positions", name: "Jabatan" }, { key: "master_data", name: "Master Data" }, { key: "shifts", name: "Shift" }, { key: "schedules", name: "Jadwal" }, { key: "attendance", name: "Absensi" }, { key: "payroll", name: "Payroll" }, { key: "kpi", name: "KPI" }, { key: "assets", name: "Aset" }, { key: "announcements", name: "Pengumuman" }, { key: "audit", name: "Audit" }];
